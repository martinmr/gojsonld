...
func testToRDF(input string, output string, produceGeneralizedRDF bool, t *testing.T) {
	...
	dataset, datasetErr := ToRDF(inputJSON, options)
	if !isNil(datasetErr) {
		t.Error("Could not convert to RDF: " + datasetErr.Error())
		return
	}
	if !reflect.DeepEqual(dataset, outputRDF) {
...
func TestToRDF0016(t *testing.T) {
	testToRDF("toRdf-0016-in.jsonld", "toRdf-0016-out.nq", false, t)
}

func TestToRDF0017(t *testing.T) {
	testToRDF("toRdf-0017-in.jsonld", "toRdf-0017-out.nq", false, t)
}

func TestToRDF0018(t *testing.T) {
	testToRDF("toRdf-0018-in.jsonld", "toRdf-0018-out.nq", false, t)
}
...
func TestToRDF0045(t *testing.T) {
	testToRDF("toRdf-0045-in.jsonld", "toRdf-0045-out.nq", false, t)
}
...
func TestToRDF0068(t *testing.T) {
	testToRDF("toRdf-0068-in.jsonld", "toRdf-0068-out.nq", false, t)
}

func TestToRDF0069(t *testing.T) {
	testToRDF("toRdf-0069-in.jsonld", "toRdf-0069-out.nq", false, t)
}
...
func TestToRDF0080(t *testing.T) {
	testToRDF("toRdf-0080-in.jsonld", "toRdf-0080-out.nq", false, t)
}
...
func TestToRDF0088(t *testing.T) {
	testToRDF("toRdf-0088-in.jsonld", "toRdf-0088-out.nq", false, t)
}
...
func TestToRDF0090(t *testing.T) {
	testToRDF("toRdf-0090-in.jsonld", "toRdf-0090-out.nq", false, t)
}

func TestToRDF0091(t *testing.T) {
	testToRDF("toRdf-0091-in.jsonld", "toRdf-0091-out.nq", false, t)
}
...
func TestToRDF0096(t *testing.T) {
	testToRDF("toRdf-0096-in.jsonld", "toRdf-0096-out.nq", false, t)
}

func TestToRDF0097(t *testing.T) {
	testToRDF("toRdf-0097-in.jsonld", "toRdf-0097-out.nq", false, t)
}
...
func TestToRDF0099(t *testing.T) {
	testToRDF("toRdf-0099-in.jsonld", "toRdf-0099-out.nq", false, t)
}

func TestToRDF0100(t *testing.T) {
	testToRDF("toRdf-0100-in.jsonld", "toRdf-0100-out.nq", false, t)
}
...
func TestToRDF0106(t *testing.T) {
	testToRDF("toRdf-0106-in.jsonld", "toRdf-0106-out.nq", false, t)
}
...
func TestToRDF0118(t *testing.T) {
	testToRDF("toRdf-0118-in.jsonld", "toRdf-0118-out.nq", true, t)
}
